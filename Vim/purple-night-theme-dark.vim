  ...
  let s:guishade0 = "#595c87"
  let s:guishade1 = "#ffffff"
  let s:guishade2 = "#ffffff"
  let s:guishade3 = "#ffffff"
  let s:guishade4 = "#ffffff"
  let s:guishade5 = "#ffffff"
  let s:guishade6 = "#ffffff"
  let s:guishade7 = "#ffffff"
  let s:guiaccent0 = "#c3e88d"
  let s:guiaccent1 = "#e995ff"
  let s:guiaccent2 = "#c3e88d"
  let s:guiaccent3 = "#00cdff"
  let s:guiaccent4 = "#94cef2"
  let s:guiaccent5 = "#00cdff"
  let s:guiaccent6 = "#db9cf7"
  let s:guiaccent7 = "#f79ce0"
  let s:ctermshade0 = 103
  let s:ctermshade1 = 231
  let s:ctermshade2 = 231
